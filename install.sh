...
# Usage: curl -sSL https://raw.githubusercontent.com/YOUR_GITHUB_USERNAME/YOUR_REPO_NAME/main/install.sh | bash

SKILL_NAME="prompt-optimizer"
SKILL_FILE="prompt-optimizer.skill"
REPO_URL="https://github.com/YOUR_GITHUB_USERNAME/YOUR_REPO_NAME/releases/latest/download/$SKILL_FILE"
